# Contributing to the Ascender Pro Installer

Thanks for your interest in contributing to the Ascender Pro Installer. This document covers the
...
```bash
git clone https://github.com/<your-user>/ascender-pro-install.git
...
Open an issue at
[github.com/ctrliq/ascender-pro-install/issues](https://github.com/ctrliq/ascender-pro-install/issues).
